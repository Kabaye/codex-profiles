...
Follow the shared [installation and migration procedure](../docs/install.md) with profile `lite`. It covers backups, model metadata validation, role cleanup, config merging and live smoke tests. Do not install by copying only AGENTS.md.
